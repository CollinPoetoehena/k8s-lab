...
TODO: explain here how the project is structured in short (can generate with AI).
TODO: now about what I want with the project structure, but add more details about the subfolders, etc. Also, add more explanation on what is in each folder, etc.
The more details can be in a README.md in the specific folder so that it is clearer and this below is just a summary. 
